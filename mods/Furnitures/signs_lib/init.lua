...
if enable_colored_metal_signs then
	...
	local sign_colors = {
		{"green",        S("green"),       "f", "00FF00"},
		{"yellow",       S("yellow"),      "0", "FFFF00"},
		{"red",          S("red"),         "f","FF0000"},
		{"white",    S("white"),   "4","F5F5F5"},
		{"black",  S("black"), "0","292421"},
		{"orange",       S("orange"),      "0","FF6103"},
		{"blue",         S("blue"),        "f","0000FF"},
		{"pink",        S("pink"),       "f","FF69B4"},
	}
