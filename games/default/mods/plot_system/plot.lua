...
local plotposy = tonumber(minetest.setting_get("plot_system_plotposy")) or 0
...
local plotblock = minetest.setting_get("plot_system_plotblock") or "color:orange"
local plotblocktop = minetest.setting_get("plot_system_plotblocktop") or "color:green"
local plotborder = minetest.setting_get("plot_system_plotborder") or "stairs:slab_white"
local pathwidth = tonumber(minetest.setting_get("plot_system_pathwidth")) or 3
local pathblock = minetest.setting_get("plot_system_pathblock") or "color:yellow"
local borderwidth = 1
